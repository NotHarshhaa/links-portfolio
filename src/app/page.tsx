...
export default function HomePage() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-b from-white to-neutral-100 dark:from-neutral-950 dark:to-black">
      ...
      <div className="fixed top-20 -left-10 md:left-10 w-72 md:w-96 h-72 md:h-96 bg-purple-200/30 dark:bg-purple-900/20 rounded-full blur-3xl animate-pulse -z-10"></div>
      <div className="fixed top-40 -right-10 md:right-10 w-72 md:w-96 h-72 md:h-96 bg-blue-200/30 dark:bg-blue-900/20 rounded-full blur-3xl animate-pulse -z-10"></div>
...
function SectionContainer({ title, delay, items, special, id }: SectionContainerProps) {
  return (
    <MotionSection 
      id={id}
      data-skip-animation
      className={`w-full max-w-[95vw] md:max-w-md lg:max-w-2xl mt-8 rounded-3xl p-4 sm:p-6 backdrop-blur-lg border border-neutral-200/50 dark:border-neutral-800/50 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-[1.01] ${
        special 
